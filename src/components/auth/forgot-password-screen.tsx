        ...
        <View className="gap-6" style={{ width: contentWidth }}>
          ...
          <View className="gap-4 rounded-lg border border-white/30 bg-white/10 p-4">
            <View className="gap-1 px-1">
              <Text className="text-xs font-black uppercase text-pronto-muted">
                Recupero password
              </Text>
              <Text className="text-[32px] font-black leading-9 text-white">
                Reimposta l'accesso
              </Text>
              <Text className="text-base leading-[22px] text-pronto-mist">
                Inserisci la tua email istituzionale. Ti invieremo un link per impostare una
                nuova password.
              </Text>
            </View>
          </View>
          ...
          <View className="gap-5 rounded-lg border border-pronto-line bg-pronto-surface p-5 shadow-lg">
            ...
            >
              <Text className="text-base font-black text-white">Invia link di recupero</Text>
            </Pressable>

            {hasSentLink ? (
              <View className="rounded-lg border border-pronto-line bg-pronto-teal-soft px-4 py-3">
                <Text className="text-sm font-bold leading-5 text-pronto-ink">
            ...
            <View className="flex-row flex-wrap items-center justify-center gap-x-1 gap-y-1">
              ...
              <Link href="/login" asChild>
                <Pressable className="px-1 py-1">
                  <Text className="text-sm font-black text-pronto-teal-dark">Accedi</Text>
                </Pressable>
              </Link>
            </View>
          </View>
          ...
          <View className="rounded-lg border border-white/25 bg-white/10 px-4 py-3">
            <Text className="text-center text-sm font-semibold leading-5 text-pronto-mist">
              Nessuna email viene inviata davvero: questa e solo interfaccia.
            </Text>
          </View>
        </View>
      </ScrollView>
